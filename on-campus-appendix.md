...
<details>
  <summary style="cursor: pointer; padding: 10px; background-color: #333; color: white; border-radius: 4px; margin-bottom: 10px;"><strong>Math</strong></summary>
...
<details>
  <summary style="cursor: pointer; padding: 10px; background-color: #333; color: white; border-radius: 4px; margin-bottom: 10px;"><strong>Values</strong></summary>
  <div style="padding-left: 20px; margin-bottom: 15px;">
...
<details>
  <summary style="cursor: pointer; padding: 10px; background-color: #333; color: white; border-radius: 4px; margin-bottom: 10px;"><strong>Science</strong></summary>
  <div style="padding-left: 20px; margin-bottom: 15px;">
